...
/***/ "./node_modules/immutable-update/dist-modules/index.js":
/*!*************************************************************!*\
  !*** ./node_modules/immutable-update/dist-modules/index.js ***!
  \*************************************************************/
...
/* harmony export */   "default": () => (/* binding */ newState)
/* harmony export */ });
/* harmony import */ var lodash_assignwith__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! lodash.assignwith */ "./node_modules/lodash.assignwith/index.js");
...
/* harmony import */ var lodash_foreach__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! lodash.foreach */ "./node_modules/lodash.foreach/index.js");
...
/* harmony import */ var lodash_mergewith__WEBPACK_IMPORTED_MODULE_5__ = __webpack_require__(/*! lodash.mergewith */ "./node_modules/lodash.mergewith/index.js");
...
/* harmony import */ var lodash_set__WEBPACK_IMPORTED_MODULE_6__ = __webpack_require__(/*! lodash.set */ "./node_modules/lodash.set/index.js");
 ...
 */
function newState(state, newStateProps) {
  var overwrite = arguments.length > 2 && arguments[2] !== undefined ? arguments[2] : [];

  var merged = Array.isArray(state) ? [] : {};

  if (lodash_isplainobject__WEBPACK_IMPORTED_MODULE_4___default()(newStateProps)) {
    ...
    lodash_assignwith__WEBPACK_IMPORTED_MODULE_0___default()(merged, state, function (mergedVal, stateVal, key) {
      return newStateProps[key] === undefined ?
  ...
  lodash_mergewith__WEBPACK_IMPORTED_MODULE_5___default()(merged, state, newStateProps, function (prevValue, newValue) {
    if (prevValue === newValue) {
      ...
      return prevValue;
    } else if (lodash_isplainobject__WEBPACK_IMPORTED_MODULE_4___default()(prevValue) && lodash_isplainobject__WEBPACK_IMPORTED_MODULE_4___default()(newValue)) {
  ...
  lodash_foreach__WEBPACK_IMPORTED_MODULE_2___default()(overwrite, function (key) {
    lodash_set__WEBPACK_IMPORTED_MODULE_6___default()(merged, key, lodash_clonedeep__WEBPACK_IMPORTED_MODULE_1___default()(lodash_get__WEBPACK_IMPORTED_MODULE_3___default()(newStateProps, key)));
  });
...
var Image = function Image(props) {
  return /*#__PURE__*/React.createElement("div", {
    ...
    className: "Title"
  }, /*#__PURE__*/React.createElement((react_highlight_words__WEBPACK_IMPORTED_MODULE_2___default()), {
...
var edit = function edit(props) {
  var _state$results$posts;
  var _useReducer = useReducer(function (state, action) {
      var newstate = (0,immutable_update__WEBPACK_IMPORTED_MODULE_0__["default"])(state, action);
      return newstate;
    }, {
      tree: [],
  ...
  var settree = function settree(children, list, level) {
    if (!list) {
      list = [];
    }
    if (!level) {
    ...
    var leveltabs = (0,lodash__WEBPACK_IMPORTED_MODULE_1__.times)(level, function () {
      return '-';
    }).join('');
  ...
  var selectfolders = function selectfolders(values) {
    dispatch({
      results: []
    });
    props.setAttributes({
  ...
  var setSearchInput = function setSearchInput(text) {
    dispatch({
      searchtext: text,
      results: []
    });
  ...
  useEffect(function () {
    fetch('/wp-json/ongadi/imagebank/folders').then(function (response) {
      return response.json().then(settree);
    });
  }, []);
  return /*#__PURE__*/React.createElement("div", {
    ...
    variant: "secondary",
    disabled: !(state.searchtext && state.searchtext.length > 3 && state.filebirdfolders),
    onClick: search
  }, "Buscar")), /*#__PURE__*/React.createElement("div", {
    className: "Results"
  }, !state.filebirdfolders ? /*#__PURE__*/React.createElement("div", {
    className: "Message"
  }, "Select some File Bird Folder") : !state.searchtext || state.searchtext.length < 3 ? /*#__PURE__*/React.createElement("div", {
    className: "Message"
  }, "Write text to search") : state.searching ? /*#__PURE__*/React.createElement("div", {
    className: "Message"
  }, "Searching") : !((_state$results$posts = state.results.posts) !== null && _state$results$posts !== void 0 && _state$results$posts.length) ? /*#__PURE__*/React.createElement("div", {
    className: "Message"
  }, "No results") : /*#__PURE__*/React.createElement("div", {
    className: "List"
  }, /*#__PURE__*/React.createElement("div", {
    className: "ListMessage"
  }, "Found ", state.results.postcount, " in ", state.results.attachmentcount, " images"), /*#__PURE__*/React.createElement("div", {
    className: "\n              ListPosts\n              Columns_".concat(props.attributes.columns, "\n            ")
  }, state.results.posts.map(function (image) {
    return /*#__PURE__*/React.createElement(Image, _extends({}, image, {
      terms: state.results.terms
    }));
...
registerBlockType('ongadi/imagebank', {
  title: __('Image Bank'),
  icon: 'format-gallery',
  category: 'ongadi',
  attributes: {
